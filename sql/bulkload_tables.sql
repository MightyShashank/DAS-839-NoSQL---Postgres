...
\COPY keywords(id, term, score)
FROM 'Wikipedia-EN-20120601_KEYWORDS.TSV'
WITH (FORMAT CSV, DELIMITER E'\t', ENCODING 'UTF8');

\COPY uris(id, uri)
FROM 'Wikipedia-EN-20120601_REVISION_URIS.TSV'
WITH (FORMAT CSV, DELIMITER E'\t', ENCODING 'UTF8');